...
if (-not $SkipPackageCheck) {
    $RequiredFiles = @(
        ...
        "bin\docker-common.ps1",
        "bin\docker-generate-env.ps1",
        "bin\docker-migrate-existing-db.ps1",
        "bin\docker-backup-db.ps1",
        "bin\docker-restore-db.ps1",
        "bin\docker-status.ps1",
        "bin\docker-stop.ps1",
