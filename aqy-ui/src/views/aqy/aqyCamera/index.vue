    ...
    >
      <div class="preview-container">
        <div class="preview-header">
          <span class="camera-name">{{ currentCamera.eqmtName }}</span>
          <span class="camera-status" :class="currentCamera.onlineStatus === 1 ? 'online' : 'offline'">
        ...
        <div class="preview-footer">
          <span class="device-info">设备编号：{{ currentCamera.qmtCode }}</span>
