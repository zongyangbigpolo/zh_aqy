        ...
        <el-table v-loading="loading" :data="dataList" :max-height="tableHeight" border style="width: 100%;">
          ...
          <el-table-column label="X角度(°)" align="center" prop="xvalueQj" v-if="searchType === 'QJ'">
            <template slot="header">
              <span>X角度(°)</span>
              <el-tooltip effect="dark" placement="top">
                <div slot="content">x轴为平行于边坡方向</div>
                <i class="el-icon-question" style="margin-left: 5px; cursor: pointer;"></i>
              </el-tooltip>
            </template>
          </el-table-column>
          ...
          <el-table-column label="Y角度(°)" align="center" prop="yvalueQj" v-if="searchType === 'QJ'">
            <template slot="header">
              <span>Y角度(°)</span>
              <el-tooltip effect="dark" placement="top">
                <div slot="content">y轴为垂直于边坡方向</div>
                <i class="el-icon-question" style="margin-left: 5px; cursor: pointer;"></i>
              </el-tooltip>
            </template>
          </el-table-column>
          ...
          <el-table-column label="Z角度(°)" align="center" prop="zvalueQj" v-if="searchType === 'QJ'">
            <template slot="header">
              <span>Z角度(°)</span>
              <el-tooltip effect="dark" placement="top">
                <div slot="content">z轴为垂直于水平方向</div>
                <i class="el-icon-question" style="margin-left: 5px; cursor: pointer;"></i>
              </el-tooltip>
            </template>
            <template slot-scope="scope">
          ...
          <el-table-column label="位移照片" align="center" prop="picture" v-if="searchType === 'WY'">
            <template slot-scope="scope">
              <el-image
