      ...
      <div class="sphere">
        ...
        <div class="sum">
          <p class="alarm-p" v-if="alarmStatusData.hasAlarm">
              <span v-for="item in alarmStatusData.items" v-if="alarmStatusData.hasAlarm && item.maxAlarmLevel > 0"
                    :class="alarmStatusData.maxLevel === 1 ? 'spanColor3 alarmSpeed3'
                            : alarmStatusData.maxLevel === 2 ? 'spanColor2 alarmSpeed2'
                            : alarmStatusData.maxLevel === 3 ? 'spanColor1 alarmSpeed1' : ''">
                {{item.eqmtTypeName + '[' + item.eqmtName + ']报警:' + item.maxAlarmLevel + '级'}}
              </span>
          </p>
